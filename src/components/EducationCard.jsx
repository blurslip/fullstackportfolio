...
function EducationCard({ showDeleteBtn = true }) {
  ...
  const educations = [
    ...
    },
    {
      ...
      toDate: "Nov 2025",
      certificate:
        "https://drive.google.com/file/d/1Z6wfVhg1PgS44KqJRMgTQZ73Z7aFIWfF/view?usp=sharing",
    },
    {
      education: "iCore Software Systems Private Limited, Chennai",
      description: "Java Full Stack Intern",
      fromDate: "Nov 2025",
      toDate: "Present",
    },
  ];
              ...
              {education.certificate && (
                <div>
                  <a href={education.certificate} target="_blank">
                    <h1 className="text-[#5FB9B0] text-[20px]">
                      View Certificate
                    </h1>
                  </a>
                </div>
